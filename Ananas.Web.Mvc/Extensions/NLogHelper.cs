...
namespace Ananas.Web.Mvc.Extensions
{
    public class NLogHelper
    {
        ...
        ///     
        /// </remarks>
        public static void LogWriter(String msg,String IP,String logType = "Info", bool loginState = true)
        {
            try
            {
                ...
                //String IP = Request.HttpContext.Connection.RemoteIpAddress;  //获取IP
                //反射执行日志方法
